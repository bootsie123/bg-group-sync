...
export const FUNCTION_NAME = "blackbaudGetUser";
 ...
 */
export async function blackbaudGetUser(userId: number, context: InvocationContext) {
  ...
  try {
    ...
    const user = await blackbaud.getUser(userId, true);
